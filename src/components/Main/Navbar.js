...
export const Navbar = (props) => {
      return (
            <div>
                  <div className='bg-gradient-to-t from-gray-800 to-black'>

                        <nav class="border-gray-200 px-2 mb-10">
                              <div class="container mx-auto flex flex-wrap items-center justify-between">
                                    <a href="/" class="flex">
                                          <img src="https://www.svgrepo.com/show/1320/rocket.svg" className=' mr-3 w-[51px] h-[70px]' alt="gh" />
                                          ...
                                          <span class="self-center text-[30px] font-semibold whitespace-nowrap text-white">StarDust</span>
                                    </a>
                                    ...
                                    <div class="hidden md:flex justify-between items-center w-full md:w-auto md:order-1" id="mobile-menu-3">
                                          <ul class="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium">
                                                <li>
                                                      <Link to="/" class="text-white text-[20px] md:bg-transparent block pl-3 pr-4 py-2 md:text-gray-100 md:p-0 rounded" aria-current="page">Home</Link>
                                                </li>
                                                <li>
                                                      <Link to="/about" class="text-white text-[20px] hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-white md:p-0">About</Link>
                                                </li>
                                          </ul>
                                    </div>
                              </div>
